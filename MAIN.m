...
% Last Modified by GUIDE v2.5 02-Dec-2018 21:09:56
...
if(isempty(handles))
    ...
    friction = str2num(get(handles.Friction_Value,'String'));
    ...
    log_file = strcat(file_location,'\Log\groupABC_LOG.TXT');
...
% --- Executes during object creation, after setting all properties.
function tire_option_CreateFcn(hObject, eventdata, handles)
% hObject    handle to tire_option (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --------------------------------------------------------------------
function road_condition_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to road_condition (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

function Friction_Value_Callback(hObject, eventdata, handles)
% hObject    handle to Friction_Value (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of Friction_Value as text
%        str2double(get(hObject,'String')) returns contents of Friction_Value as a double



% --- Executes during object creation, after setting all properties.
function Friction_Value_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Friction_Value (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes when selected object is changed in road_condition.
function road_condition_SelectionChangedFcn(hObject, eventdata, handles)
% hObject    handle to the selected object in road_condition 
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
  tire_selection_popup = get(handles.tire_option,'Value');
  road_condition = get(get(handles.road_condition,'SelectedObject'), 'String');
  friction = determine_friction(tire_selection_popup, road_condition);
  set(handles.Friction_Value,'string',num2str(friction));
% --- Executes on selection change in tire_option.
function tire_option_Callback(hObject, eventdata, handles)
% hObject    handle to tire_option (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns tire_option contents as cell array
%        contents{get(hObject,'Value')} returns selected item from tire_option
  tire_selection_popup = get(handles.tire_option,'Value');
  road_condition = get(get(handles.road_condition,'SelectedObject'), 'String');
  friction = determine_friction(tire_selection_popup, road_condition);
  set(handles.Friction_Value,'string',num2str(friction));
 
function friction = determine_friction(tire, road_condition)
if (road_condition == "Snow" && tire == 1)
    friction = 0.3;
elseif (road_condition =="Wet" && tire == 1)
    friction = 0.7;
elseif (road_condition =="Dry" && tire == 1)
    friction = 1.1;
elseif (road_condition == "Snow" && tire == 2)
    friction = 0.1;
elseif (road_condition == "Wet" && tire == 2)
    friction = 0.3;
elseif (road_condition == "Dry" && tire == 2)
    friction = 0.7;
end
